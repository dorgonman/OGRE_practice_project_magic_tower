...
void Stage2::createScene(){
	Stage::createScene();
	//cout << "start load parameter" << endl;
	GameParameter mParameter;
	mParameter.readData("stage2_parameter.txt");
	...
	{//terrain
		sceneMgr->setWorldGeometry("stage2_terrain.cfg");  
		sceneMgr->setSkyBox(true, "Examples/TrippySkyBox");
	}
