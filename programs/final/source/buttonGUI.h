...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    **  BUTTON  CLASS    **   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		button(std::string &buttonName, std::string &material, buttonPosition &position, short width, short height, buttonManager * mgr, Ogre::Overlay * o, button * parentButton, textScheme &style, bool isActiveButton);
			...
			* inside buttonManager->getEvent()    The only reason to turn of triggers is for efficiency or to reduce feedback from the mButtonMgr
			*  
			*
			...
			*/
			...
			Ogre::Real getWidth(void)	{ panel->getWidth();}
			Ogre::Real getHeight(void)	{ panel->getHeight();}
		...
		protected:
				...
				buttonManager * const mButtonMgr;
...
class textInputArea : public button
	{
		...
		public:
			...
			*/
			...
			/**
			* Send a submit message from mButtonMgr with a poitner to this button and the text it contains in additionalData
...
class buttonMesh  //internal class to help manage 3D stuff in the buttons
	{
		...
		public:
			buttonMesh(const Ogre::String name, const Ogre::String meshFile, buttonManager * mButtonMgr, button* parentButton, short unsigned int zOrder, short positionX, short positionY,  short width, short height) ;
			~buttonMesh();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    **  BUTTON  MANAGER CLASS    **   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		*/
		...
		/**
		*  clears the mButtonMgr of all buttons
		*/
